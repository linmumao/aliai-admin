    ...
    <div id="activitytype">
        ...
        <div id="toptop">
          <div id="topone">
            <div style="display: flex; align-items: center;">
              ...
              >
              <el-select
                v-model="dataOne.activityStatus"
                placeholder="全部"
                size="small"
              >
                <el-option
          ...
          <div style="margin-top: 10px;">
            <span
              style="white-space:nowrap;margin-right: 12px; font-size: 14px; font-weight: 600;"
              >活动时间：</span
            >
            <el-date-picker
              v-model="dataOne.createTimeOne"
              :clearable="false"
              type="date"
              size="small"
            >
      ...
      <div style="margin: 20px 0 15px 0 ;">
        <el-button type="primary" size="mini" @click="addMember"
          ><span style="font-size: 20px;">+</span> 新增</el-button
        >
      </div>
      <div id="middle">
          ...
          >
            <template slot-scope="scope">
              <el-button size="mini" type="primary" @click="editUser(scope.row)"
                >编辑</el-button
              >
              <el-button size="mini" type="primary" @click="addData(scope.row)"
                >数据</el-button
              >
              ...
              <el-button
                size="mini"
                type="primary"
                @click="deleteactivitylist(scope.row)"
                >删除</el-button
              >
            </template>
          </el-table-column>
      ...
      <div>
        ...
        >
          ...
          <div style="margin-top: 50px;text-align: center; ">
            ...
            <el-button type="primary" @click="uploadneiactivitylist"
              >保存</el-button
            >
          </div>
        </el-dialog>
