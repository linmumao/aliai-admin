                ...
                <div class="margintop">
                    ...
                    <div id="responsetime">
                        <div class="responsetimechild">
                            <div>
                                平均<span style="font-size: 24px; color: #1677FF; margin: 0 5px; ">{{ activityPeriod
                                }}</span>天
                            </div>
                        ...
                        <div class="responsetimechild">
                            <div>
                                平均<span style="font-size: 24px; color: #1677FF; margin: 0 5px; ">{{ processingTime
                                }}</span>天
                            </div>
        ...
        <div id="bottomcontent">
            ...
            <div>
                <div style="margin-top: 15px;">
                    <el-table :header-cell-style="{ background: '#f5f7fa', color: '#000' }" :data="tableData"
                        style="width: 100%">
                        <el-table-column type="index" label="序号" width="120">
                        </el-table-column>
                        <el-table-column prop="activityName" label="活动名称" width="280">
                        </el-table-column>
                        <el-table-column prop="belongBank" label="所属支行" width="280">
                        </el-table-column>
                        <el-table-column prop="activityDate" label="活动日期" width="280">
                        </el-table-column>
        ...
        calendar() {
            calendar().then((res) => {
                ...
                const events = res.data.map((item) => {
                    const tmp = {};
                    tmp.title = item.activityName;
                    tmp.date = item.activityDate;
                    return tmp;
                });
