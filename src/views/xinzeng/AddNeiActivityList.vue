                ...
                <div class="asidecss">
                    ...
                    <el-form :model="form" >
                        <el-form-item label="活动名称：" :label-width="formLabelWidth">
                            <el-input v-model="form.activityName" autocomplete="off" style="width: 338px;" ></el-input>
                        </el-form-item>
                        ...
                        <el-form-item label="活动地点：" :label-width="formLabelWidth">
                            <el-input v-model="form.activityAddress" autocomplete="off" style="width: 338px;"></el-input>
                        </el-form-item>
                        <el-form-item label="备注：" :label-width="formLabelWidth">
                            <textarea name="one" id="one"  v-model="form.remark" placeholder="请输入不多50字的描述"    maxlength="10">
                            </textarea>
                        </el-form-item>
                    </el-form>
                </div>
...
import {addneiactivitylist , updataactivitylist ,journal , findbankbranch , downloadfiles , downloadpictures , downloadtext } from '../../api/xinzeng'
