        ...
        <el-aside class="aside">
          <el-menu :default-active="activeMenu" router :unique-opened="true" @open="handleOpen" @close="handleClose"
            ...
            <div>
              ...
              <el-submenu v-for="(item,index) in newList.treeList" :index="item.menuId">
                <template slot="title">
                  <img :src="item.img" style="width: 0.625rem;height: 0.625rem;margin-right: 0.3125rem;" alt="" />
                  <span style="font-size: 0.5rem;">{{item.name}}</span>
                </template>
                <template v-for="(ite,inde) in item.children">
                  ...
                  <el-menu-item v-else :index="ite.router">
                    <span style="margin-left: 0.34375rem;font-size: 0.5rem;">{{ite.name}}</span>
                  </el-menu-item>
                </template>
              </el-submenu>
            </div>
